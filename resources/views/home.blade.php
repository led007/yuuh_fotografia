...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    <head>
        <meta charset="utf-8">
        <title>Yuuh Ribeiro - Fotografia</title>
                ...
                <div class="container"> 
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#brand">
                            <img class="logo2" src="assets/images/logo.png" class="logo" alt="">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="main_about text-center">
                                ...
                                <a href="https://www.instagram.com/hey.yuuh/" target="_blank" class="btn btn-primary m-top-100 "><i class="fab fa-instagram fa-lg insta"></i>Instagram</a> 
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="grid-item transition metal ium">
                                ...
                                <div class="grid_hover_area text-center">
                                    <div class="girid_hover_text m-top-110">
                                        ...
                                        <a href="assets/images/1.jpg" class="btn btn-primary popup-img">Ver mais</a>
                                    </div>
                            ...
                            <div class="grid-item metalloid " >
                                ...
                                <div class="grid_hover_area text-center">
                                    <div class="girid_hover_text m-top-180">
                                        <h4 class="text-white">Modelo</h4>
                                        <p class="text-white">- It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                                        <a href="assets/images/2.jpg" class="btn btn-primary popup-img">Ver mais</a>
                                    </div>
                                </div><!-- End off grid Hover area -->
                            </div><!-- End off grid item -->
                            ...
                            <div class="grid-item post-transition metal numberGreaterThan50">
                                ...
                                <div class="grid_hover_area text-center">
                                    <div class="girid_hover_text m-top-50">
                                        <h4 class="text-white">Modelo</h4>
                                        <p class="text-white">- It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                                        <a href="assets/images/3.jpg" class="btn btn-primary popup-img">Ver mais</a>
                                    </div>
                                </div><!-- End off grid Hover area -->
                            </div><!-- End off grid item -->
                            ...
                            <div class="grid-item post-transition metal ium" >
                                ...
                                <div class="grid_hover_area text-center">
                                    <div class="girid_hover_text m-top-180">
                                        <h4 class="text-white">Modelo</h4>
                                        <p class="text-white">- It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                                        <a href="assets/images/4.jpg" class="btn btn-primary popup-img">Ver mais</a>
                                    </div>
                                </div><!-- End off grid Hover area -->
                            </div><!-- End off grid item -->
                            ...
                            <div class="grid-item metal ar" >
                                ...
                                <div class="grid_hover_area text-center">
                                    <div class="girid_hover_text m-top-110">
                                        <h4 class="text-white">Modelo</h4>
                                        <p class="text-white">- It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                                        <a href="assets/images/5.jpg" class="btn btn-primary popup-img">Ver mais</a>
                                    </div>
                                </div><!-- End off grid Hover area -->
                            </div><!-- End off grid item -->
                            ...
                            <div class="grid-item alkali ar" >
                                ...
                                <div class="grid_hover_area text-center">
                                    <div class="girid_hover_text m-top-50">
                                        <h4 class="text-white">Modelo</h4>
                                        <p class="text-white">- It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                                        <a href="assets/images/6.jpg" class="btn btn-primary popup-img">Ver mais</a>
                                    </div>
                                </div><!-- End off grid Hover area -->
                            </div><!-- End off grid item -->
                                ...
                                <div class="service_slid">
                                    ...
                                    <div class="service_slid_item text-center">
                                        <div class="service_slid_text">
                                            ...
                                            <h5 class="text-black m-top-20">Ensaios</h5>
                                        </div>
                                        <div class="service_slid_text">
                                            <i class="fas fa-camera fa-7x"></i>
                                            <h5 class="text-black m-top-20">Porta-Retratos</h5>
                                        </div>
                                        <div class="service_slid_text">
                                            <i class="fas fa-video fa-7x"></i>
                                            <h5 class="text-black m-top-20">Filmagens</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-5 col-md-offset-1">
                                <div class="service_item sm-m-top-50">
                                    <div class="head_title">
                                        <h2 class="text-uppercase">Meus <strong>Serviços</strong></h2>
                                    </div>
                                    <div class="service_content">
                                        ...
                                        <a href="" class="btn btn-default m-top-40">Saiba Mais</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="main_teams_content fix">
                            <div class="col-md-6">
                                <div class="teams_item">
                                    <div class="head_title">
                                        <h2 class="text-uppercase">Meus <strong>Parceiros</strong></h2>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="teams_item text-center sm-m-top-50">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <img src="assets/images/p1.jpg" alt="" class="img-circle" />
                                            <h4 class="m-top-20">Shibari <strong>Terrenos</strong></h4>
                                            <h5>Artista de Shibari</h5>
                                            <div class="separator"></div>
                                            <ul class="list-inline">
                                                <li><a href="https://www.facebook.com/shibarientrenos" target="_blank"><i class="fa fa-facebook"></i></a></li>
                                                <li><a href="https://www.instagram.com/shibarientrenos/" target="_blank"><i class="fa fa-instagram"></i></a></li>
                                                <li><a href=""><i class="fa fa-twitter"></i></a></li>
                                            </ul>
                                        </div><!-- End off col-md-4 -->
                                        <div class="col-sm-4">
                                            <img src="assets/images/p2.jpg" alt="" class="img-circle" />
                                            <h4 class="m-top-20">Yuuh <strong>Ribeiro</strong></h4>
                                            <h5>Fotógrafa & Modelo</h5>
                                            <div class="separator"></div>
                                            <ul class="list-inline">
                                                <li><a href="https://www.facebook.com/yuuh.watashi" target="_blank"><i class="fa fa-facebook"></i></a></li>
                                                <li><a href="https://www.instagram.com/hey.yuuh/" target="_blank"><i class="fa fa-instagram"></i></a></li>
                                                <li><a href=""><i class="fa fa-twitter"></i></a></li>
                                            </ul>
                                        </div><!-- End off col-md-4 -->
                                        <div class="col-sm-4">
                                            <img src="assets/images/p3.jpg" alt="" class="img-circle" />
                                            <h4 class="m-top-20">Lucas <strong>Eduardo</strong></h4>
                                            <h5>Web Engineer</h5>
                                            <div class="separator"></div>
                                            <ul class="list-inline">
                                                <li><a href="https://www.facebook.com/profile.php?id=100003023774652" target="_blank"><i class="fa fa-facebook"></i></a></li>
                                                <li><a href="https://www.instagram.com/_xxenomorfo/" target="_blank"><i class="fa fa-instagram"></i></a></li>
                                                <li><a href="https://github.com/led007" target="_blank"><i class="fa fa-github"></i></a></li>
                                            </ul>
                                        </div><!-- End off col-md-4 -->
                                    </div>
                                </div>
                            ...
                            <div class="skill">
                                <div class="team_content_details_skills m-top-50">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="teamskillbar clearfix m-top-50 text-uppercase" data-percent="100%">
                                                <label>Clientes Satisfeitos</label>
                                                <div class="teamskillbar-bar" style="width: 90%;"></div>
                                            </div> <!-- End Skill Bar -->

                                            <div class="teamskillbar clearfix m-top-50 text-uppercase" data-percent="50%">
                                                <label>Filmagens</label>
                        ...
                        <div class="main_choose">
                            ...
                            <div class="col-md-5 col-md-offset-1">
                                <div class="choose_content sm-m-top-40">
                                    <div class="head_title">
                                        <h2 class="text-uppercase">Porque <strong>Me escolher?</strong></h2>
                                    </div>
                                    <div class="choose_item_text fix">
                                        <h6><i class="fa fa-check-square-o"></i> What is Lorem Ipsum?</h6>
                    ...
                    <div class="main_features fix roomy-70">
                        ...
                        <div class="col-md-5">
                            <div class="features_item">
                                <div class="head_title">
                                    <h2 class="text-uppercase">Sobre <strong>Mim</strong></h2>
                                </div>
                        ...
                        <div class="col-md-6 col-md-offset-1 sm-m-top-50">
                            <div class="features_item2_area">
                                <div class="features_item2 text-center">
                                    <img class="sobrefoto" src="assets/images/s1.jpg" alt="" />
                        ...
                        <div class="main_test fix">
                            <div class="col-md-6">
                                <div  style="display: flex">
                                    <img  class="dimg" src="assets/images/d1.jpg" alt="" />
                                    <img class="dimg" src="assets/images/d2.jpg" alt="" />
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 sm-m-top-40">
                                <div class="test_item1 fix ">
                                    <div class="head_title fix">
                                        <h2 class="text-uppercase">O que <strong>dizem os Clientes</strong></h2>
                                    </div>
                                    <div class="item_img">
                                        <img class="img-circle" src="assets/images/dd1.jpg" alt="" />
                                        <i class="fa fa-quote-left"></i>
                                    </div>

                                    <div class="item_text">
                                        <h5>Suicide Girls</h5>
                                        <h6>@suicidegirls.bra</h6>
